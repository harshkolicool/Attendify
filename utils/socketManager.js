...
function emitAttendanceMarked(session, student, attendanceRecord, distance, updatedCounts = null) {
    ...
    const payload = {
        ...
        acousticDistance: attendanceRecord && attendanceRecord.deviceInfo && attendanceRecord.deviceInfo.acousticDistanceMeters ? attendanceRecord.deviceInfo.acousticDistanceMeters : null,
        acousticRowCategory: attendanceRecord && attendanceRecord.deviceInfo && attendanceRecord.deviceInfo.acousticRowCategory ? attendanceRecord.deviceInfo.acousticRowCategory : null,
        verificationMethod: attendanceRecord && attendanceRecord.verificationMethod ? attendanceRecord.verificationMethod : "GEOLOCATION",

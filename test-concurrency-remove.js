    ...
    for (let i = 0; i < 10; i++) {
        promises.push((async () => {
            try {
                ...
                // Simulate wasAbsentOverridden logic
                s.presentStudents = s.presentStudents.filter(x => x.fullName !== "Student to remove");
                ...
                console.error("Save error for", i, ":", err.name, err.message);
            }
        })());
    }
